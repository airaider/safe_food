...
public class FoodSaxParser {
	private String nutritionFilePath = "src/main/resources/static/xml/FoodNutritionInfo.xml";
	private String foodFilePath = "src/main/resources/static/xml/foodInfo.xml";
	private StringBuilder xml;
	private List<Food> foods;
	
 	public FoodSaxParser() throws IOException {
		loadData();	
	}
